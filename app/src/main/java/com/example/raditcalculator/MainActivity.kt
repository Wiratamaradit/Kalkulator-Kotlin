package com.example.raditcalculator


import android.os.Bundle
import android.widget.Toast
import androidx.appcompat.app.AppCompatActivity
import com.example.raditcalculator.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            btnTitik.setOnClickListener { appendOnClick(true, ".") }
            //        membuat listener dari operator dalam kalkulator
            btnTambah.setOnClickListener { appendOnClick(false, "+") }
            btnKurang.setOnClickListener { appendOnClick(false, "-") }
            btnKali.setOnClickListener { appendOnClick(false, "*") }
            btnBagi.setOnClickListener { appendOnClick(false, "/") }
            btnkurungkiri.setOnClickListener { appendOnClick(false, "(") }
            btnkurungkanan.setOnClickListener { appendOnClick(false, ")") }
